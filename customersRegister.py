...
class CustomerRegister:
    def __init__(self, cust_app):
        ...
        def add_cust():
            if name_text.get() == '' or lastname_text.get() == '' or email_text.get() == '' \
                    or access_key_text.get() == '' or phone_text.get() == '':
        ...
        add_btn = tk.Button(button_frame, text='Create Account', width=12, command=add_cust, bg=shared.BG_COLOR)
...
if __name__ == "__main__":
    cust_app2 = tk.Tk()
    application = CustomerRegister(cust_app2)
